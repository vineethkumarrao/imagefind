"""
Satellite Images Uploader for Appwrite
Uploads satellite images to Appwrite storage and extracts features
"""
...
def upload_satellite_images(image_dir: str = "data/professional_images/satellite"):
    """
    ...
    try:
        ...
        logger.info("🚀 Initializing Satellite Uploader...")
...
if __name__ == '__main__':
    try:
        ...
        if len(sys.argv) > 1:
            ...
            image_dir = "data/professional_images/satellite"
        
        upload_satellite_images(image_dir)
