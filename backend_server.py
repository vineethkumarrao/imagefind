...
def get_quantum_algorithm():
    ...
    if quantum_algorithm is None:
        logger.info("⚛️  Loading AE-QIP v3.0.0 quantum algorithm...")
        from src.quantum.ae_qip_v3 import AEQIPAlgorithm
...
logger.info("🚀 Initializing Quantum Image Retrieval API with 512D features...")
app = FastAPI(
...
async def upload_and_store(
    ...
    try:
        ...
        logger.info("☁️  Storing in Appwrite...")
...
async def startup_event():
    ...
    logger.info(f"⚛️  Quantum Mode: {'Inspired' if config.USE_QUANTUM_INSPIRED else 'True Quantum'}")
